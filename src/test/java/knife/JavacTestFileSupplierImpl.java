...
public class JavacTestFileSupplierImpl extends JavacFileSupplierBase implements JavacFileSupplier {

    private final String testCase;
    private final StandardJavaFileManager fm;
    
    @Inject
    public JavacTestFileSupplierImpl(@Named("testCase") String testCase, 
